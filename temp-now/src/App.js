    ...
    if (!data) {
        ...
        return (react_1.default.createElement("div", { className: "App" },
            react_1.default.createElement("div", { className: 'container' },
                ...
                temperature.map((dailyTemperatures, index) => {
                    return react_1.default.createElement(Card_1.default, { daily: { daily }, temperatures: dailyTemperatures, index: index });
                }))));
    }
}
exports.default = App;
